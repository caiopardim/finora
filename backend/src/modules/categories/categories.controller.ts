import { Controller, Get, Post, Put, Delete, Body, Param, Headers, Inject, UnauthorizedException } from '@nestjs/common';
...
export class CategoriesController {
  ...
  @Put(':id')
  async update(@Headers('authorization') auth: string, @Param('id') id: string, @Body() dto: any) {
    return this.service.update(await this.getUserId(auth), id, dto);
  }
